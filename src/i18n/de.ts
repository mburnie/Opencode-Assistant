...
export const de: I18nDictionary = {
  ...
  "cmd.description.mcplist": "MCP-Server auflisten und umschalten",
  "cmd.description.opencode_start": "OpenCode-Server starten",
  "cmd.description.opencode_stop": "OpenCode-Server stoppen",
  "cmd.description.soul": "Identität des Assistenten anzeigen (soul, nur lesen)",
  "cmd.description.personality": "Verhaltensregeln (Ton, Formalität, Sprache) anzeigen oder bearbeiten",
  "cmd.description.show_tools": "Sichtbarkeit von Tool-Call-Nachrichten umschalten",
  ...
  "cmd.description.skill_update": "Skills von ihrer Quell-URL erneut herunterladen",
  ...
  "tts.status_template":
    "🎙 *TTS-Einstellungen*\nAktiviert: {enabled}\nAnbieter: {provider} ({provider_source})\nStimme: {voice} ({voice_source})\nGeschwindigkeit: {speed}\n\nVerwendung:\n  /tts on | off — Audio ein-/ausschalten\n  /tts provider <name> — Anbieter wechseln (edge, openai, speechify, google)\n  /tts voice <id> — Stimme ändern (/tts list für Optionen)\n  /tts speed <0.5..2.0> — schneller/langsamer\n  /tts list [anbieter] — Stimmen auflisten",
  "tts.provider_changed": "✅ TTS-Anbieter geändert auf: {provider}",
  "tts.provider_invalid":
    "Ungültiger Anbieter. Gültig: edge, openai, speechify, google",
  "tts.provider_not_configured":
    "Anbieter {provider} benötigt nicht gesetzte Anmeldedaten. /tts provider edge für gratis Fallback ohne API-Key.",
  "tts.voice_changed": "✅ Stimme: {voice}",
  "tts.voice_unknown":
    "Stimme \"{voice}\" nicht gefunden für Anbieter {provider}. /tts list für Optionen.",
  "tts.speed_changed": "✅ Geschwindigkeit: {speed}x.",
  "tts.speed_invalid": "Geschwindigkeit muss eine Zahl zwischen 0.5 und 2.0 sein.",
  "tts.list_header": "🎙 Stimmen für {provider}:",
  "tts.list_more":
    "...und {count} weitere. /tts list {provider} {locale} zum Filtern nach Sprachcode.",
  "tts.list_empty": "Keine Stimmen für diesen Anbieter/Locale.",
  "tts.error": "TTS-Einstellung konnte nicht aktualisiert werden.",
  ...
  "runtime.wizard.start": "Opencode-Assistant Einrichtung.\n",
  "runtime.wizard.saved": "Konfiguration gespeichert:\n- {envPath}\n- {settingsPath}\n",
  "runtime.wizard.not_configured_starting":
    "Anwendung ist noch nicht konfiguriert. Starte Assistent...\n",
  "runtime.wizard.tty_required":
    "Der interaktive Assistent erfordert ein TTY-Terminal. Führe `opencode-assistant config` in einer interaktiven Shell aus.",
  ...
  "cron.delivery.continue_button": "▶️ In aktiver Sitzung fortfahren",
  "cron.delivery.cancel_button": "❌ Verwerfen",
  "cron.delivery.continuing_callback": "Wird in aktive Sitzung injiziert...",
  "cron.delivery.discarded_callback": "Verworfen",
  "cron.delivery.discarded": "❌ Cron-Ergebnis verworfen.",
  "cron.delivery.no_active_session":
    "Keine aktive Sitzung. Starte eine mit /new und tippe erneut auf Fortfahren.",
  "cron.delivery.expired": "Dieses Cron-Ergebnis ist nicht mehr verfügbar.",
  "cron.delivery.inject_failed":
    "🔴 Cron-Ergebnis konnte nicht in die aktive Sitzung injiziert werden.",
