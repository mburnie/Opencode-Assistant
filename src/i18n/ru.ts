...
export const ru: I18nDictionary = {
  ...
  "cmd.description.soul": "Просмотр идентичности ассистента (soul, только чтение)",
  "cmd.description.personality": "Просмотр и изменение правил поведения (тон, формальность, язык)",
  "cmd.description.show_tools": "Переключение видимости сообщений вызова инструментов",
  ...
  "runtime.wizard.start": "Настройка Opencode-Assistant.\n",
  "runtime.wizard.saved": "Конфигурация сохранена:\n- {envPath}\n- {settingsPath}\n",
  "runtime.wizard.not_configured_starting":
    "Приложение еще не сконфигурировано. Запускаю wizard...\n",
  "runtime.wizard.tty_required":
    "Интерактивный wizard требует TTY-терминал. Запустите `opencode-assistant config` в интерактивной оболочке.",
