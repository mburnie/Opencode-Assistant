...
export const zh: I18nDictionary = {
  ...
  "cmd.description.soul": "查看助手身份（soul，只读）",
  "cmd.description.personality": "查看或编辑行为规则（语气、正式程度、语言）",
  "cmd.description.show_tools": "切换工具调用消息的可见性",
  ...
  "runtime.wizard.start": "Opencode-Assistant 设置。\n",
  "runtime.wizard.saved": "配置已保存：\n- {envPath}\n- {settingsPath}\n",
  "runtime.wizard.not_configured_starting": "应用尚未配置。正在启动向导...\n",
  "runtime.wizard.tty_required":
    "交互式向导需要 TTY 终端。请在交互式 shell 中运行 `opencode-assistant config`。",
  ...
  "cron.delivery.continue_button": "▶️ 在当前会话继续",
  "cron.delivery.cancel_button": "❌ 丢弃",
  "cron.delivery.continuing_callback": "正在注入到当前会话...",
  "cron.delivery.discarded_callback": "已丢弃",
  "cron.delivery.discarded": "❌ 已丢弃定时任务结果。",
  "cron.delivery.no_active_session": "没有活动会话。请先用 /new 创建会话，再点击继续。",
  "cron.delivery.expired": "该定时任务结果已不可用。",
  "cron.delivery.inject_failed": "🔴 无法将定时任务结果注入当前会话。",
